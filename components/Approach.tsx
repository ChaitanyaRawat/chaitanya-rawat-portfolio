        ...
        <section className="w-full py-20">
            ...
            <div className="my-20 flex flex-col lg:flex-row items-center justify-center gap-4">
                <Card
                    ...
                    description="Planning and strategy for the project."
                >
                    <CanvasRevealEffect
                        animationSpeed={5.1}
                ...
                <Card
                    ...
                    description="Development and progress update for the project."
                >
                    <CanvasRevealEffect
                        animationSpeed={3}
                ...
                <Card
                    ...
                    description="Development and launch of the project."
                >
                    <CanvasRevealEffect
                        animationSpeed={3}
